...
PROCESS-NAME,com.baidu.searchbox,{{ rule }} # 百度APP
...
PROCESS-NAME,com.lolaage.tbulu.tools,{{ rule }} # 两步路
...
PROCESS-NAME,com.meijialove.activity,{{ rule }} # 美甲帮
...
PROCESS-NAME,com.zuinengsheng.io,{{ rule }} # 奶萌
