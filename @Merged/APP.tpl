...
PROCESS-NAME,com.fanliwanggouwulianmeng,{{ rule }} # 返利购物联盟
...
PROCESS-NAME,com.hhhl.health,{{ rule }} # 健康头条
...
PROCESS-NAME,com.Qinjia.info,{{ rule }} # 亲呗
...
PROCESS-NAME,com.rednet.moment,{{ rule }} # 时刻新闻
...
PROCESS-NAME,com.shl.takethatfun.cn,{{ rule }} # 接招小视频剪辑
...
PROCESS-NAME,com.sparke.clipmaster,{{ rule }} # 视频编辑精灵
...
PROCESS-NAME,com.tommy.mjtt_an_pro,{{ rule }} # 美景听听智慧旅游语音导游
...
PROCESS-NAME,com.tsy.tsy,{{ rule }} # 淘手游（673游戏交易）
...
PROCESS-NAME,com.zjst.houai,{{ rule }} # 好郎中
...
PROCESS-NAME,net.nanhuaboyi.app,{{ rule }} # 南华期货掌上交易
